...
<body>
    ...
    <br />
    {{-- @dd('asse' . ' => ' . floatval(array_sum($gbalance_total)), 'liab' . ' => ' . floatval(array_sum($gbalance_total2)), 'cap' . ' => ' . floatval(array_sum($gbalance_total3)), 'rev' . ' => ' . floatval(array_sum($balance_total4)), ' exp' . ' => ' . floatval(array_sum($balance_total5))); --}}
