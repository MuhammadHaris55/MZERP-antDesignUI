            ...
            <div class="">
                ...
                >
                    ...
                    >
                        <div
                            v-if="errors.entries"
                            class="bg-red-100 border px-4 border-red-400 text-red-700 rounded"
                            role="alert"
                        >
                            {{ errors.entries }}
                        </div>
    ...
    methods: {
        ...
        tcredit() {
            ...
            for (var i = 0; i < this.form.entries.length; i++) {
                dtotal = dtotal + parseFloat(this.form.entries[i].credit);
            }
            this.credit = dtotal.toFixed(2);
        },
        tdebit() {
            let dtotal = 0;
            for (var i = 0; i < this.form.entries.length; i++) {
                dtotal = dtotal + parseFloat(this.form.entries[i].debit);
            }
    ...
    watch: {
        ...
        debit: function () {
            ...
            if (this.debit == 0 && this.credit == 0) {
                ...
                diff = parseFloat(this.debit) - parseFloat(this.credit);
